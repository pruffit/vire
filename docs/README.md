...
[product/overhang.md](product/overhang.md) — сколько построено против того, сколько
может работать при нынешнем числе людей: классификация фич по требуемой массе
(N=1 / N>1 / N>>1), пороги, на которых алгоритмы сами себя выключают, цена фоновой
работы вхолостую.

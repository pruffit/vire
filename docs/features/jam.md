...
**Вечеринка — режим джема**, а не отдельная механика: `jam_sessions.kind = 'PARTY'`
переключает очередь на круговую вставку по участникам и разрешает внешние позиции
(ссылка с любого сервиса, файл с устройства). Комнаты, участники, SSE, синхронизация,
транспорт и мини-бар — общий код. Что расходится — вход, панель добавления, экран
вечеринки и слой источников звука: [`party.md`](party.md).

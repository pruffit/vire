...
> Список «НЕДАВНЕЕ» из стенда намеренно НЕ переносился: он там леса, чтобы под стеклом ехал
> контент. Продуктового эндпоинта недавно прослушанного нет (`play_events` — аналитический
> лог), главная остаётся на своих SDUI-блоках.

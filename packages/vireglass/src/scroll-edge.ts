// Краевой эффект прокрутки (эталон 219 @8:52) — работа ЭКРАНА, а не материала: он ложится на
// контент под панелью, и стекло видит уже приглушённый фон. Здесь только общие правила.

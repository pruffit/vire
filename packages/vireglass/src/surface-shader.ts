...
/* Расфокус краски под пальцем, dp при полном нажатии (эталон §6): глиф теряет кромку и
 * тонет в молоке. В покое радиус нулевой, и выборка остаётся одиночной. */
const float VG_INK_DEFOCUS = 1.6;
...
half4 main(float2 xy) {
  ...
  float defocus = VG_INK_DEFOCUS * u_touchPress;

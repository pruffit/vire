 ...
 *  кнопки при том же нажатии. Замеры этим же пробником: 109% с правилом и ровно 0% без него
 *  (подъём выключен — оба случая совпадают до единицы). Порог посередине ловит и полное
 *  отключение, и ослабление эффекта вдвое. */
const MIN_LIFT_SPREAD = 0.5;

...
Тривиалку (опечатка/переименование/копирайт) — мимо цикла. Роутинг моделей: Opus только
на суждение (дизайн/план/дебаг), Sonnet — реализация, Haiku — поиск/маппинг/тривиал.

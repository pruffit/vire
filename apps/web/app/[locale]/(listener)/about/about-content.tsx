...
const FOR_LISTENERS: Feature[] = [
  { icon: 'play-circle', title: 'Плеер и поток', text: 'Глобальный плеер на всех страницах: очередь, перемотка по форме волны, горячие клавиши (пробел, стрелки, M, R — повтор). Звук — потоком, без скачивания файлов.' },
  ...
  { icon: 'list', title: 'Плейлисты', text: 'Свои подборки в один клик: добавляй, переименовывай, удаляй. Приватно или по ссылке. Чужие публичные подборки можно лайкать — они соберутся в медиатеке.' },
...
const FOR_ARTISTS: Feature[] = [
  ...
  { icon: 'link-2', title: 'Смартлинки', text: 'Лендинги релиза со ссылками на все площадки — работают даже без публикации музыки на VireMusic.' },
];
  ...
  return (
    <main className="mx-auto min-h-full max-w-3xl px-6 py-16 sm:py-20 space-y-24">
      ...
      <ContentHero
        ...
        subtitle="VireMusic — площадка, где артисты публикуют музыку без посредников, а слушатели находят её без алгоритмической гонки и рекламы. Сейчас идёт первый, ламповый этап — запускаемся в кругу своих и допиливаем платформу вместе с вами."
      />

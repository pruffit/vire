...
const { findByUserId, findById, releaseFindById, getAudioFeaturesSnapshot } = vi.hoisted(() => ({
  findByUserId: vi.fn(),
  findById: vi.fn(),
...
function makeReq(): Request {
  return new Request(`http://localhost/api/v1/dashboard/tracks/${TRACK_ID}/audio-features`);
}

beforeEach(() => vi.clearAllMocks());

describe('GET /api/v1/dashboard/tracks/[id]/audio-features', () => {

...
const COLOR_LITERAL_ALLOWLIST: Record<string, { overlay: boolean; reason: string }> = {
  ...
  'components/artist-card.tsx': { overlay: false, reason: 'temporary — срез B/C' },
  ...
  'components/editorial-playlist-card.tsx': { overlay: false, reason: 'temporary — срез B/C (в карте плана, топ-15)' },
  'components/featured-release.tsx': { overlay: false, reason: 'temporary — срез B/C (в карте плана, топ-15)' },
  ...
  'app/(listener)/smartlink/[artistSlug]/[linkSlug]/page.tsx': { overlay: false, reason: 'temporary — срез B/C (в карте плана, топ-15)' },
  ...
  'components/release-countdown.tsx': { overlay: false, reason: 'temporary — срез B/C (в карте плана, топ-15)' },
  ...
  'components/release-quick-look.tsx': { overlay: false, reason: 'temporary — срез B/C (в карте плана, топ-15)' },
  ...
  'components/track-row.tsx': { overlay: false, reason: 'temporary — срез B/C (в карте плана, топ-15)' },
...
const RAW_EYEBROW_ALLOWLIST = new Set<string>([
  ...
  'app/(listener)/artists/[slug]/artist-popular-tracks.tsx',
  'app/(listener)/design/interactive-demos.tsx',
  'app/(listener)/design/page.tsx',
  'app/(listener)/jam/page.tsx',
  'app/(listener)/jam/[code]/jam-join.tsx',
  'app/(listener)/nrvz914/page.tsx',
  'app/(listener)/nrvz914/[code]/party-screen.tsx',
...
describe('design tokens: роли и запрет литералов вне allowlist', () => {
  ...
  it('роли label-mono/readout и text-wrap:balance определены в packages/ui/src/globals.css', () => {

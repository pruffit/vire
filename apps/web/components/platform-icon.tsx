...
// Простые оригинальные глифы (не копии брендовых лого) под каждый ключ площадки.
// Наследуют цвет через currentColor, размер — через `size`. Достаточно узнаваемы
// и визуально различимы; точные бренд-лого можно навесить позже.

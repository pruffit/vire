...
/**
 * Content-kit — единый словарь публичных/контентных поверхностей: о платформе,
 * дизайн-система, правовые страницы, обратная связь, 404, анонсы.
 *
 * Регистр (Impeccable / маркетинговый, в отличие от продуктового ui-kit.tsx):
 * - акцент через `primary`, нейтраль через `muted-foreground`;
 * - карточки `border-border bg-card`, hover подсвечивает бордер/радиальное свечение;
 * - mono-uppercase eyebrow-метки, числовые секции с волосяной линией;
 * - вход — CSS `animate-fade-up` (server-friendly), scroll-reveal — `Reveal`.
 *
 * Извлечён из страницы «О платформе» — она же первый потребитель.
 */

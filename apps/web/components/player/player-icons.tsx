// Иконки, специфичные для плеера. Часть — тонкие обёртки над общим спрайтом
// (`components/icon.tsx`), часть — составные глифы, которых в спрайте нет.
// Вынесены сюда, чтобы мини-бар/фуллскрин/очередь не дублировали свои копии.

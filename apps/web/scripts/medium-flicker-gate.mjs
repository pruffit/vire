#!/usr/bin/env node
/**
 * Гейт на мигание среды: покадровая светлота и знак приращения между кадрами — мера и порог
 * калиброваны в `docs/vireglass/benchmarks/2026-09-14-medium-cost.md`.
 *

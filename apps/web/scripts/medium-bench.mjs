#!/usr/bin/env node
/**
 * Замер стоимости среды поверх стекла при 0/1/3/6 стёклах, живая среда vs статичная подложка —
 * методика и калибровка: `docs/vireglass/benchmarks/2026-09-14-medium-cost.md`.
 *

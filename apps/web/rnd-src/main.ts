 ...
 *
 * Материал берётся КАК ЕСТЬ, мимо `materialForInk`: это лаборатория среды, и читаемость тут
 * крутят руками. Продукт так не делает — там она либо 0.95, либо 0, — поэтому замеры по этой
 * детали задавай читаемость в адресе явно, иначе меряешь умолчание стенда, а не продукт.
 */

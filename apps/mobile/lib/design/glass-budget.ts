...
// То же число держит dev-предупреждение реестра поверхностей внутри пакета. Импортировать его
// оттуда нельзя — подпуть нативный и тянет Skia в любой чистый тест; расхождение ловит гейт.
